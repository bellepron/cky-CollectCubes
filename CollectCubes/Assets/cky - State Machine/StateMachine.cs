...
namespace cky.AI
{
    public class StateMachine
    {
        ...
        public void RemoveTransition(IState from, IState to, Func<bool> condition)
        {
            if (transitions.TryGetValue(from.GetType(), out var _transitions) == true)
            {
                _transitions.Remove(new Transition(to, condition));
            }
        }
